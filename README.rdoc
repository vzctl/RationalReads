...
5.  Is the rating backbone model getting used? [done - yes, it is, for the create action]
6.  Add comments instantaneously, instead of waiting for the comment to save


#Next Steps
1.  Create comment rails model and controller
2.  Create comments in the console
3.  Display the comments
4.  Get the comments create to work
