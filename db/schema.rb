...
ActiveRecord::Schema.define(version: 20150503235546) do
  ...
  add_index "follows", ["work_id"], name: "index_follows_on_work_id", using: :btree
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean  "display_ratings",     default: true
  end
  ...
  create_table "works", force: :cascade do |t|
    ...
    t.integer  "ones",             default: 0,   null: false
    t.integer  "twos",             default: 0,   null: false
